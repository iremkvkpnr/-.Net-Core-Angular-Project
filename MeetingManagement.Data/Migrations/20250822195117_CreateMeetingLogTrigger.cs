...
{
    /// <inheritdoc />
    public partial class CreateMeetingLogTrigger : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Create triggers for Meeting table logging
            migrationBuilder.Sql(@"
                CREATE TRIGGER tr_Meeting_Insert
                AFTER INSERT ON Meetings
                BEGIN
                    INSERT INTO MeetingLogs (MeetingId, Title, Description, StartDate, EndDate, DocumentPath, UserId, Operation, LoggedAt, LoggedBy)
                    VALUES (
                        NEW.Id,
                        NEW.Title,
                        NEW.Description,
        ...
        {
            // Drop triggers
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS tr_Meeting_Insert;");
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS tr_Meeting_Update;");
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS tr_Meeting_Delete;");
